// Format any timestamp (ISO string or Date object) to various formats
export function formatTimestamp(timestamp: any, format = "default") {
  if (!timestamp) {
    return "Invalid timestamp";
  }

  // Handle ISO strings, Date objects, or timestamp objects
  let date: Date;
  ...
  if (timestamp instanceof Date) {
    ...
    // Legacy Firebase timestamp format support
...
export const formatFirebaseTimestamp = formatTimestamp;
