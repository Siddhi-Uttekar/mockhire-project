      ...
      >
        <div className="flex flex-col items-center space-y-6">
          {text.toLowerCase().includes("reva") && (
            <div className="bounce-text flex items-center justify-center w-16 h-16 rounded-full bg-blue-900 shadow-lg">
          ...
          <div className={cn("loader-container relative", config.height)}>
            <p
              className={cn(
                "loader-text absolute top-0 left-0 p-0 m-0 tracking-wider text-neutral-100 whitespace-nowrap font-medium",
                config.text
              )}
