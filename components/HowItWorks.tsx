...
//                 <Play className="h-10 w-10 text-sky-300 ml-1" />
//               </div> */}
//             {/* </div> */}
//             <div className="w-full h-full bg-pink-950/10 flex items-center justify-center">
...
//                 <div className="w-12 h-12 rounded-full bg-pink-950/20 flex items-center justify-center mb-4">
//                   <span className="text-sky-300 font-bold text-xl">1</span>
//                 </div>
...
//               <CardContent className="pt-6">
//                 <div className="w-12 h-12 rounded-full bg-pink-950/20 flex items-center justify-center mb-4">
//                   <span className="text-sky-300 font-bold text-xl">2</span>
//                 </div>
...
//               <CardContent className="pt-6">
//                 <div className="w-12 h-12 rounded-full bg-pink-950/20 flex items-center justify-center mb-4">
//                   <span className="text-sky-300 font-bold text-xl">3</span>
//                 </div>
