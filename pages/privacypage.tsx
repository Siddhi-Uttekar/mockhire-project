      ...
      <Card className="bg-white shadow-md border border-gray-200">
        <CardContent className="p-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-6 mt-6 text-gray-900">
              Privacy Policy
            </h1>
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    ...
                    number, employment history, educational background, and
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Provide, maintain, and improve our AI interview platform
                    </li>
                    <li>
                      Generate personalized interview questions and feedback
                    </li>
                    <li>
                      Analyze your interview performance and provide insights
                    </li>
                    <li>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      ...
                      information when you explicitly agree
                    </li>
                    <li>
                      <strong>Service providers:</strong> We work with trusted
                      third-party companies to help operate our platform
                    </li>
                    <li>
