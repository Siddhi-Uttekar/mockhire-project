      ...
      {resumeUrl || currentFile ? (
        ...
        <div
          className={`border-2 border-dashed rounded-lg p-8 text-center transition-colors ${
            dragActive
              ? "border-orange-600 dark:border-blue-800 bg-pink-950/10 dark:bg-blue-900/20"
              : "border-gray-300 dark:border-gray-600 hover:border-orange-600 dark:hover:border-blue-800 hover:bg-pink-950/10 dark:hover:bg-blue-900/20"
          }`}
        ...
        >
          <div className="space-y-4">
            ...
            <Button
              ...
              className="bg-blue-900 hover:bg-slate-800 text-white rounded-lg"
            >
